...
// let user = new classUser.User("a", "b", "c", "d", "e")
...
$(function () {
    ...
    //newP.text("I am <strong>very excited </strong> very excited for the opening of the new adaptation of his work.");

    // TO DO: append to newP text
    newP.html("I am <strong>very excited </strong> very excited for the opening of the   new adaptation of his work.");
...
//             }
 ...
 if($("#speckled-excerpt")){
    let aspDiv = "<img class = 'asp-image' src ='./images/asp.jpeg' alt ='Silhouette of sherlock Holmes and a bunch of snakes '>";
...
if ($("#btnRegSubmit")) {
    ...
    $("#btnRegSubmit").click(function (e) {
        ...
        // validate first name
        $("#first-group div.errorMessage").html(formValidation.validateFirst(unvalidated_user.firstName));

        // validate last name

        $("#last-group div.errorMessage").html(formValidation.validateLast(unvalidated_user.lastName));

        // validate  username
        $("#username-group div.errorMessage").html(formValidation.validateUsername(unvalidated_user.username));

        // validate confirm password
        let passConfError = formValidation.validatePassword(unvalidated_user.password, $("#inputPassword2").val());
        $("#pass1-group div.errorMessage").html(passConfError);
        $("#pass2-group div.errorMessage").html(passConfError);
...
if(".gallery"){
    ...
    $(function(){
        ...
        // get the image tag
        let galleryImage = $(".gallery").children("img").first();
